...
namespace CatApp.Controllers
{
    public class StreamingController : Controller
    {
        ...
        public StreamingController(ILogger<StreamingController> logger, 
            ProductService productServicep, IConfiguration config)
        {
            _logger = logger;
            _productService = productServicep;
            ...
            while (section != null)
            {
                ...
                if (hasContentDispositionHeader)
                {
                        ...
                        .HasFormDataContentDisposition(contentDisposition))
                    {
                        ...
                        var encoding = GetEncoding1(section);
 ...
 var prod = new Product
        ...
        private static Encoding GetEncoding1(MultipartSection section)
        {
